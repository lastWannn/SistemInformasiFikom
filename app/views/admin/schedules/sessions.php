        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <div class="flex items-center gap-2">
                            ...
                            <span
                                class="text-slate-400 text-xs font-bold uppercase tracking-wider"><?= e($plan['lab_name']) ?></span>
                        </div>
                ...
                <div class="flex gap-3">
                    <div class="bg-[#1c1b22] px-4 py-2 rounded-xl border border-white/10 shadow-sm text-center">
                        <span class="block text-xs text-slate-400 font-bold uppercase">Total Sesi</span>
                        <span class="block text-lg font-bold text-slate-200"><?= count($sessions) ?></span>
                    </div>
                    <div class="bg-[#1c1b22] px-4 py-2 rounded-xl border border-white/10 shadow-sm text-center">
                        <span class="block text-xs text-slate-400 font-bold uppercase">Dosen</span>
                        <span
                            class="block text-lg font-bold text-slate-200 text-ellipsis overflow-hidden w-24 whitespace-nowrap"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
                ...
                <?php
                        ...
                        $statusBadge = $isPast
                            ? '<span class="text-[10px] bg-slate-100 text-slate-400 px-2 py-0.5 rounded border border-white/10 font-bold">Selesai</span>'
                ...
                <div
                    class="group bg-[#1c1b22] rounded-2xl border border-white/10 shadow-sm hover:shadow-md hover:border-primary-300 transition-all duration-300 relative overflow-hidden <?= $cardOpacity ?>">

                    <div class="px-5 py-4 border-b border-slate-50 flex justify-between items-start bg-[#131218]/30">
                        <div>
                    ...
                    <div class="p-5">
                        <div class="flex items-center gap-4 mb-4">
                            <div
                                class="flex flex-col items-center justify-center w-14 h-14 bg-[#131218] rounded-xl border border-white/5 text-slate-300 group-hover:bg-primary-50 group-hover:text-primary-700 group-hover:border-primary-100 transition-colors">
                            ...
                            <div>
                                <h3 class="font-bold text-white text-lg leading-tight"><?= $dayIndo ?></h3>
                                <p class="text-sm font-mono text-slate-400 mt-0.5 flex items-center gap-1">
                        ...
                        <div class="flex gap-2">
                            <a href="<?= url('/admin/sessions/' . $session['id']) ?>"
                                class="flex-1 py-2.5 text-center text-sm font-bold text-slate-400 bg-[#131218] rounded-xl border border-transparent hover:bg-[#1c1b22] hover:border-white/10 hover:shadow-sm transition-all">
                                Detail
                            </a>
            ...
            <?php else: ?>
            <div
                class="flex flex-col items-center justify-center py-20 bg-[#1c1b22] rounded-2xl border border-dashed border-slate-300">
                <div class="w-20 h-20 bg-[#131218] rounded-full flex items-center justify-center text-slate-300 mb-4">
                    <i class="bi bi-calendar-x text-4xl"></i>
                </div>
                <h3 class="text-lg font-bold text-white">Tidak ada sesi ditemukan</h3>
                <p class="text-slate-400 text-sm mt-1 max-w-sm text-center">
