...
<div class="admin-layout antialiased bg-slate-50 min-h-screen">
    ...
    <main class="p-4 sm:ml-64 pt-8 transition-all duration-300">
        <div class="max-w-4xl mx-auto">
            ...
            <form method="POST" action="<?= url('/admin/laboratories/create') ?>" enctype="multipart/form-data">
                        ...
                        <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 sticky top-6">
                            ...
                            <div
                                ...
                                <div id="preview-container" class="hidden mb-3">
                                    <img id="preview-img" src="#" class="w-full h-40 object-cover rounded-lg shadow-sm">
                                </div>
