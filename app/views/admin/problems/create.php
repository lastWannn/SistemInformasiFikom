        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    ...
                    <p class="text-slate-400 text-sm">Input masalah teknis laboratorium secara manual.</p>
                </div>
            </div>
                ...
                <form action="<?= url('/admin/problems/create') ?>" method="POST">
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label class="block mb-2 text-sm font-bold text-slate-300">Nomor PC / Perangkat</label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label class="block mb-2 text-sm font-bold text-slate-300">Nama Pelapor
                                    (Opsional)</label>
