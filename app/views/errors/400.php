...
<body class="bg-gradient-to-br from-red-50 to-rose-50 min-h-screen flex items-center justify-center p-4">
        ...
        <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-red-600 to-rose-600 px-8 py-6">
                <div class="flex items-center justify-center gap-4">
                    <div class="w-16 h-16 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center">
                        <i class="bi bi-exclamation-octagon text-4xl text-white"></i>
                    </div>
            ...
            <div class="px-8 py-12 text-center">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="<?= url('/') ?>" 
                       class="inline-flex items-center justify-center gap-2 px-6 py-3 bg-red-600 hover:bg-red-700 text-white font-medium rounded-lg transition-all shadow-lg shadow-red-500/30">
